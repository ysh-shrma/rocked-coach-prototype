...
export const personas: Persona[] = [
  {
    ...
    nodes: {
      ...
      n2_holds: {
        id: "n2_holds",
        customerLine: "Good, I appreciate a straight answer. If I can get financing sorted today, can you hold it for me until Saturday?",
        choices: [
...

  {
    ...
    nodes: {
      n0: {
        id: "n0",
        customerLine: "I'll be straight with you — the last dealership sold my sister a car with a hidden recall and didn't say a word. Is this Corolla clean?",
        groundTruth: { kind: "vehicle", stock: "D-COROLLA" },
        choices: [
          { id: "a", text: "Actually, no — full disclosure, it has an open recall on the fuel pump. It's a safety recall, free at any Toyota dealer, and I can get it scheduled before you drive off.", delta: { interest: 15 }, coaching: { rapport: 3, reading: 2 }, provesCapability: true, next: "n1_honest" },
      ...
      n1_honest: {
        id: "n1_honest",
        customerLine: "...Okay. I actually appreciate you telling me straight up. What would it cost me to fix if I don't want to wait on your dealer?",
        choices: [
      ...
      n1_dodge: {
        id: "n1_dodge",
        customerLine: "Hm, okay... Actually, Toyota has a public recall database. Give me a second, let me just check this VIN myself.",
        choices: [
          { id: "a", text: "Actually — you're right to check. I should have led with this: yes, there's an open fuel pump recall, it's free to fix, let's get it scheduled.", delta: { trust: -10, interest: 10 }, coaching: { rapport: 1 }, next: "n2_shaky" },
      ...
      n1_lied: {
        id: "n1_lied",
        customerLine: "...Actually, hold on. I just looked up this VIN on my phone — there's an open safety recall on it. You just told me it's totally clean.",
        choices: [
          { id: "a", text: "You're right, and I'm sorry — I should have led with that. It's a free fuel pump recall fix, I can schedule it today.", delta: { trust: -20, interest: 5 }, coaching: {}, next: "n2_shaky" },
      ...
      n2_trustbuilt: {
        ...
        choices: [
          { id: "a", text: "Honestly, it's got 61,000 miles and one prior owner — I'll pull the full Carfax so you're not taking my word for it.", delta: { interest: 10 }, coaching: { rapport: 2 }, next: "n3_good" },
      ...
      n2_shaky: {
        id: "n2_shaky",
        customerLine: "Okay... I'm still not sure I trust what you're telling me here. What else should I know before I even consider this?",
        choices: [
          { id: "a", text: "Fair — full honesty from here: it's got 61,000 miles, one prior owner, and I'll show you the Carfax myself so you don't have to take my word for anything.", delta: { interest: 10 }, coaching: { rapport: 2 }, next: "n3_good" },
      ...
      n3_good: {
        ...
        choices: [
          { id: "a", text: "I'll schedule the recall fix today and text you once it's done, then we talk numbers with a completely clean car.", delta: { interest: 10 }, coaching: { closing: 3 }, next: "end" },
...

  {
    ...
    nodes: {
      ...
      n1_calm: {
        ...
        choices: [
          { id: "a", text: "Nothing hidden — 2022, one owner, 22,000 miles, no accidents on the Carfax, I'll show you the report right now.", delta: { interest: 10 }, coaching: { reading: 2, rapport: 1 }, next: "n2_calm" },
      ...
      n1_escalated: {
        ...
        groundTruth: { kind: "vehicle", stock: "D-WRANGLER" },
        choices: [
          { id: "a", text: "You're right, that came out wrong — let's reset. Straight answer: 2022, one owner, 22,000 miles, clean Carfax, here's the report.", delta: { trust: -5 }, coaching: { rapport: 1 }, next: "n2_calm" },
      ...
      n1_fake: {
        id: "n1_fake",
        customerLine: "...Okay, that's a weird amount of enthusiasm for that sentence. Anyway — the Wrangler out front. What's wrong with it?",
        groundTruth: { kind: "vehicle", stock: "D-WRANGLER" },
        choices: [
      ...
      n2_calm: {
        ...
        choices: [
          { id: "a", text: "I'm not going to invent a fake number to see if you'll bite — this one's priced at market, I can show you the comps.", delta: { interest: 10 }, coaching: { pressure: 3, rapport: 2 }, provesCapability: true, next: "n3_good" },
      ...
      n2_shaky: {
        ...
        choices: [
          { id: "a", text: "I'm not going to invent a number just because you're pushing — this one's priced at market, here's the comps.", delta: { interest: 5 }, coaching: { pressure: 2 }, next: "n3_good" },
      ...
      n2_overpromise: {
        ...
        choices: [
          { id: "a", text: "I get why you're skeptical after that — but I'm not inventing a number either. This one's priced at market, here's the comps.", delta: { trust: -5, interest: 5 }, coaching: { rapport: 1 }, next: "n3_good" },
...

  {
    ...
    nodes: {
      ...
      n1_reassured: {
        id: "n1_reassured",
        customerLine: "Okay... thank you. I've been looking at the Civic online. Is $24,000 actually a fair price, or is that a starting point?",
        groundTruth: { kind: "vehicle", stock: "D-CIVIC" },
        choices: [
          { id: "a", text: "It's listed at $23,800, and that's already our real number — I'm not going to make you negotiate against a fake sticker.", delta: { interest: 15 }, coaching: { rapport: 2, reading: 2 }, next: "n2_good" },
      ...
      n2_good: {
        ...
        choices: [
          { id: "a", text: "Just your license and proof of insurance — I'll walk you through every form before you sign anything, no rush.", delta: { interest: 15 }, coaching: { rapport: 2, reading: 1 }, next: "n3_good" },
      ...
      n2_shaky: {
        id: "n2_shaky",
        customerLine: "Okay... I'm getting a little nervous about the vague answers. What do I actually need to bring if I want to buy today?",
        choices: [
          { id: "a", text: "You're right to ask directly — just your license and proof of insurance, and I'll walk you through every form before you sign anything.", delta: { interest: 10 }, coaching: { rapport: 2 }, next: "n3_good" },
      ...
      n3_good: {
        ...
        choices: [
          { id: "a", text: "Let's book a test drive for tomorrow at 10, and I'll have the paperwork ready so it's quick when you come back.", delta: { interest: 15 }, coaching: { closing: 3, rapport: 1 }, provesCapability: true, next: "end" },
...

  {
    ...
    nodes: {
      n0: {
        id: "n0",
        customerLine: "I've done my homework — I know the trim, the invoice price, and what three other dealers quoted me. Please don't give me a sales pitch.",
        choices: [
      ...
      n2_good: {
        ...
        choices: [
          { id: "a", text: "Honestly, most of it is skippable — the one I'd actually recommend is the extended powertrain warranty, since you mentioned keeping it past 100k miles.", delta: { interest: 15 }, coaching: { rapport: 3, pressure: 1 }, provesCapability: true, next: "n3_good" },
      ...
      n2_shaky: {
        id: "n2_shaky",
        customerLine: "Okay... I'm a little skeptical of anything you tell me is “worth it” after that. Is there anything actually worth adding, or is it upsell junk?",
        choices: [
          { id: "a", text: "Fair to be skeptical. Honest answer: most of it's skippable — the one real recommendation is the extended powertrain warranty, given you're keeping it past 100k.", delta: { interest: 10 }, coaching: { rapport: 2 }, next: "n3_good" },
...

  {
    ...
    nodes: {
      ...
      n1_shaky: {
        ...
        groundTruth: { kind: "vehicle", stock: "D-VERSA" },
        choices: [
          { id: "a", text: "There is, and I hear you on the hard number — a 2020 Versa S, $14,200 out the door, room for tax and fees inside your $15,000.", delta: { interest: 10 }, coaching: { reading: 2 }, next: "n2_good" },
      ...
      n2_good: {
        ...
        choices: [
          { id: "a", text: "Straight answer: it's been on the lot three weeks, it's not flying off tomorrow. I'm not going to invent urgency you don't need.", delta: { interest: 15 }, coaching: { rapport: 3, pressure: 3 }, provesCapability: true, next: "n3_good" },
      ...
      n3_good: {
        ...
        choices: [
          { id: "a", text: "I can't promise nothing changes overnight, but I'll personally flag it as pending for you until end of day tomorrow.", delta: { interest: 10 }, coaching: { closing: 3 }, next: "end" },
...

  {
    ...
    nodes: {
      ...
      n1_good: {
        ...
        choices: [
          { id: "a", text: "Two concrete things: the safety package is standard here, not an add-on, and it's had one owner with full service records — I'll show you both.", delta: { interest: 15 }, coaching: { reading: 3, rapport: 1 }, next: "n2_good" },
      ...
      n1_shaky: {
        ...
        groundTruth: { kind: "vehicle", stock: "D-ALTIMA" },
        choices: [
          { id: "a", text: "Fair — specifics, not superlatives: the safety package is standard here, not an add-on, one owner with full service records.", delta: { interest: 10 }, coaching: { reading: 2 }, next: "n2_good" },
      ...
      n1_pressured: {
        ...
        groundTruth: { kind: "vehicle", stock: "D-ALTIMA" },
        choices: [
          { id: "a", text: "Fair point, that was pushy — here's what's actually different: standard safety package, one owner, full service records.", delta: { trust: -5, interest: 10 }, coaching: { rapport: 1 }, next: "n2_good" },
      ...
      n2_good: {
        ...
        choices: [
          { id: "a", text: "Honestly, not much — this one will likely still be here. What I can offer is locking today's number for 48 hours in writing, so comparing doesn't cost you the price.", delta: { interest: 15 }, coaching: { rapport: 2, closing: 2 }, provesCapability: true, next: "n3_good" },
      ...
      n2_shaky: {
        ...
        choices: [
          { id: "a", text: "Not much, honestly — I can lock today's number for 48 hours in writing, so comparing doesn't cost you anything.", delta: { interest: 10 }, coaching: { closing: 2 }, next: "n3_good" },
...

  {
    ...
    nodes: {
      n0: {
        ...
        choices: [
          { id: "a", text: "I can't give you an exact number without inspecting it, but similar 2016 Elantra trades have ranged $6,200 to $7,400 — let's get it appraised so it's a real number.", delta: { interest: 15 }, coaching: { reading: 3, rapport: 1 }, next: "n1_good" },
      ...
      n1_good: {
        ...
        choices: [
          { id: "a", text: "It reduces what you finance, dollar for dollar — the Tucson stays at $28,600, your trade offsets that, so you'd finance roughly $21,600 before tax.", delta: { interest: 15 }, coaching: { reading: 2, rapport: 1 }, next: "n2_good" },
      ...
      n1_shaky: {
        ...
        groundTruth: { kind: "trade", label: "2016 Hyundai Elantra, typical condition", rangeLow: 6200, rangeHigh: 7400 },
        choices: [
          { id: "a", text: "You're right, let me be specific — similar 2016 Elantra trades run $6,200 to $7,400, let's get yours appraised for a real number.", delta: { trust: -5, interest: 10 }, coaching: { reading: 2 }, next: "n1_good" },
      ...
      n1_overpromise: {
        ...
        groundTruth: { kind: "vehicle", stock: "D-TUCSON" },
        choices: [
          { id: "a", text: "It would, dollar for dollar — though I want to flag, $9,000 is above the typical range for that car, so the real appraisal might land lower. I don't want to overpromise.", delta: { trust: -5, interest: 10 }, coaching: { rapport: 2 }, next: "n2_good" },
      ...
      n2_good: {
        id: "n2_good",
        customerLine: "The appraisal just came back at $6,400. That's within what you said, but a bit under the $7,000 we talked about — walk me through that.",
        choices: [
          { id: "a", text: "That's on the low end of the range I gave you up front — I told you it wouldn't be exact until it was inspected. I can walk you through exactly what the appraiser flagged.", delta: { interest: 10 }, coaching: { rapport: 2, pressure: 1 }, provesCapability: true, next: "n3_good" },
      ...
      n2_shaky: {
        ...
        choices: [
          { id: "a", text: "It's within the range I gave you, on the lower end — I told you upfront it wouldn't be exact until inspected. Let me show you what the appraiser flagged.", delta: { interest: 10 }, coaching: { rapport: 2 }, next: "n3_good" },
      ...
      n2_setup_bigcontradiction: {
        ...
        choices: [
          { id: "a", text: "You're right to push on that — I overpromised earlier, and that's on me. $6,400 is what a real inspection actually found; here's exactly what the appraiser flagged.", delta: { trust: -15, patience: -10, interest: 5 }, coaching: { rapport: 1 }, next: "n3_shaky" },
      ...
      n3_good: {
        ...
        choices: [
          { id: "a", text: "I'll get the trade paperwork and the Tucson's finance numbers both ready together, so you see the whole deal at once before you sign anything.", delta: { interest: 10 }, coaching: { closing: 3 }, next: "end" },
