...
import { PreCall } from "@/components/v2/PreCall";
import { Connecting } from "@/components/v2/Connecting";
import { Call } from "@/components/v2/Call";
...
export default function RepApp() {
  ...
  return (
    <div className="v2 flex h-screen w-full items-center justify-center bg-[#e9e6f4]">
      <button
